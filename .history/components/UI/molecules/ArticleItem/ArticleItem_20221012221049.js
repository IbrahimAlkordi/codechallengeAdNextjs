      ...
      <div className={classes.articleCont}>
        ...
        <div className={classes.articleCont_imgParent}>
          {/* <img
            ...
            <Image src={image} alt="articles" width="200%" height="242px" className={classes.articleCont_compImg}></Image>
        </div>

        <div className={classes.articleCont_artDetails}>
          <h2 className={classes.articleCont_artDetails_title}>{t("home:Title")}</h2>
          <Highlighter
